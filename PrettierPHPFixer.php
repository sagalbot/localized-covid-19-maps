...
final class PrettierPHPFixer implements FixerInterface
{
    ...
    private function applyFix(SplFileInfo $file, Tokens $tokens)
    {
        ...
        exec(
            __DIR__ .
                "/node_modules/.bin/prettier --write --tab-width=4 --single-quote=true --trailing-comma-php=php7.3 $tmpFile",
        );
    ...
    private function getTmpFile(SplFileInfo $file): string
    {
        ...
        $tmpFileName = str_replace(array(DIRECTORY_SEPARATOR, ':'), '_', $file->getRealPath());
